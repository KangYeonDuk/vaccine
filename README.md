...
1. [원하는 크기의 지도 좌표를 구하는 방법](https://github.com/KangYeonDuk/vaccine/blob/main/macro.js#L17)을 참고하여 [내가 원하는 위치의 병원들](https://github.com/KangYeonDuk/vaccine/blob/main/macro.js#L65)을 설정합니다.
1. 특정 백신만을 예약하고 싶다면, [choice](https://github.com/KangYeonDuk/vaccine/blob/main/macro.js#L58)의 주석(`//`)을 제거합니다.
1. [설정한 소스](https://github.com/KangYeonDuk/vaccine/blob/main/macro.js)를 복사한 후 `DevTools`창의 `Console`에 붙여넣고 실행시킵니다.
1. `DevTools`창을 끕니다.
